class Hero:
    ...
    @staticmethod
    def calculate_effective_power(base_power_value, attribute_values):
        attribute_bonus = sum(attribute_values.values()) / len(attribute_values)

        effective_power = round(base_power_value * (1 + attribute_bonus), 1)
